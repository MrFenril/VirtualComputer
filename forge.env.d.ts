...
declare global {
  ...
  const SHELL_WINDOW_VITE_DEV_SERVER_URL: string;
  const SHELL_WINDOW_VITE_NAME: string;

  const COMPUTER_WINDOW_VITE_DEV_SERVER_URL: string;
  const COMPUTER_WINDOW_VITE_NAME: string;
